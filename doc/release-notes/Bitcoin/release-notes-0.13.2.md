Quercus Core version 0.13.2 is now available from:

  <http://quercus.org/bin/quercus-core-0.13.2/>
...
- #8908 `4a974b2` Update quercus-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow quercus-tx to create v2 transactions (fixdrak)
