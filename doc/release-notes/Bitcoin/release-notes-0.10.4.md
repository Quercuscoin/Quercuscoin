Quercus Core version 0.10.4 is now available from:

  <http://quercus.org/bin/quercus-core-0.10.4/>
...
- #6953 `43c2789` Split quercus-tx into its own package
- #6953 `dfe0d4d` Include quercus-tx binary on Debian/Ubuntu
