Quercus Core version 0.9.2.1 is now available from:

  http://quercus.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 FIX to 0.01 FIX
...
- Fix "Start quercus on system login"
