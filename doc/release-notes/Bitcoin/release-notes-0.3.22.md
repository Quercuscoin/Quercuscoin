Download URL: https://sourceforge.net/projects/quercus/files/Quercus/quercus-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 FIX fee schedule (users still pay 0.01 FIX per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #quercus00 - #quercus99
