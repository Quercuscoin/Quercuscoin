Quercus version 0.5.4 is now available for download at:
http://sourceforge.net/projects/quercus/files/Quercus/quercus-0.5.4/
...
http://gitorious.org/quercus/quercusd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Quercus-Qt notifications under Growl 1.3.
Increase required age of Quercus-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxQuercus properly when installing Quercus-Qt over it. (Windows)
