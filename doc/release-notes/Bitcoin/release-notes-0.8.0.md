Quercus-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/quercus/files/Quercus/quercus-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Quercus
...
New/changed settings (command-line or quercus.conf file)
--------------------------------------------------------
