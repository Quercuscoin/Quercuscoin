Quercus Core version 0.9.4 is now available from:

  http://quercus.org/bin/0.9.4/
...
this update is incompatible with the Quercus system and could lead to consensus
forks.

Quercus Core released binaries from http://quercus.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~quercus/+archive/ubuntu/quercus
- A third-party or self-compiled Quercus Core

upgrade to Quercus Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
