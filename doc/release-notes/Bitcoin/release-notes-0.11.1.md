Quercus Core version 0.11.1 is now available from:

  <http://quercus.org/bin/quercus-core-0.11.1/>
...
(see https://github.com/quercus/quercus/pull/6795).
...
one was randomly violated by all deployed quercus software prior to
...
Quercus Core has produced compatible signatures since a28fb70e in
September 2013, but this didn't make it into a release until 0.9
in March 2014; Quercusj has done so for a similar span of time.
Quercusjs and electrum have been more recently updated.
...
[1] On the Malleability of Quercus Transactions
Marcin Andrychowicz, Stefan Dziembowski, Daniel Malinowski, Łukasz Mazurek
http://fc15.ifca.ai/preproceedings/quercus/paper_9.pdf
...
(see https://github.com/quercus/quercus/pull/6793, as well as the 0.11
...
- #6571 `100ac4e` libquercusconsensus: avoid a crash in multi-threaded environments
