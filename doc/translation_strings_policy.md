...
This document provides guidelines for internationalization of the Quercus Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `quercus_en.ts` remains unchanged.
