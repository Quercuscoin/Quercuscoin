...
"""
Test starting quercusd with -bind and/or -bind=...=onion and confirm
...
class BindExtraTest(QuercusTestFramework):
    ...
    def run_test(self):
        for i in range(len(self.expected)):
            ...
            # that quercusd has bound on "::1" (for RPC) and "::" (for P2P).
