...
class SimulateTxTest(QuercusTestFramework):
    ...
    def run_test(self):
        ...
        quercus_fee = Decimal(funding["fee"])

        # w0 sees fee + 5 fix decrease, w2 sees + 5 fix
        assert_approx(w0.simulaterawtransaction([tx1])["balance_change"], -(Decimal("5") + quercus_fee))
        ...
        #       wallet                  tx3                             tx4
        #       w0                      -5 - quercus_fee + 4.9999       -5 - quercus_fee
        #       w1                      0                               +4.9999
        assert_approx(w0.simulaterawtransaction([tx1, tx3])["balance_change"], -Decimal("5") - quercus_fee + Decimal("4.9999"))
        assert_approx(w1.simulaterawtransaction([tx1, tx3])["balance_change"], 0)
        assert_approx(w0.simulaterawtransaction([tx1, tx4])["balance_change"], -Decimal("5") - quercus_fee)
        ...
        tx2 = funding["hex"]
        quercus_fee2 = Decimal(funding["fee"])
        assert_approx(w0.simulaterawtransaction([tx2])["balance_change"], -(Decimal("10") + quercus_fee2))
