...
By default, quercusd will dump mempool on shutdown and
...
class MempoolPersistTest(QuercusTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent quercusd from writing mempool.dat to disk. Verify that `savemempool` fails")
