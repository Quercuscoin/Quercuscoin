...
class TestQuercusCli(QuercusTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getblockchaininfo RPC and `quercus-cli getblockchaininfo`")
        ...
        self.log.info("Test -getinfo and quercus-cli return all proxies")
        ...
        if self.is_specified_wallet_compiled():
            self.log.info("Test -getinfo and quercus-cli getwalletinfo return expected wallet info")
            ...
            # Test quercus-cli -generate with -rpcwallet in multiwallet mode.
