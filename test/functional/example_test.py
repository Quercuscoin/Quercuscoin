...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the QuercusTestFramework
    pass


class ExampleTest(QuercusTestFramework):
    # Each functional test is a subclass of the QuercusTestFramework class.
    ...
    def custom_method(self):
        ...
        QuercusTestFramework class so other tests can use it."""
