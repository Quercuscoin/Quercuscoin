...
"""  Tests the net:* tracepoint API interface.
     See https://github.com/quercus/quercus/blob/master/doc/tracing.md#context-net
"""
...
class NetTracepointTest(QuercusTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("connect a P2P test node to our quercusd node")
