...
Verify that a quercusd node can use an external signer command.
...
class RPCSignerTest(QuercusTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart quercusd with -signer=<cmd>',
