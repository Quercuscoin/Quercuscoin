...
"""Verify that starting quercus with -h works as expected."""

from test_framework.test_framework import QuercusTestFramework
from test_framework.util import assert_equal

class HelpTest(QuercusTestFramework):
    ...
    def run_test(self):
        self.log.info("Start quercus with -h for help text")
        ...
        self.log.info("Start quercus with -version for version information")
        ...
        self.log.info("Start quercusd with -fakearg to make sure it does not start")
