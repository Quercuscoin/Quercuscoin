...
class TestShell:
    """Wrapper Class for QuercusTestFramework.

    The TestShell class extends the QuercusTestFramework
    ...
    class __TestShell(QuercusTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by QuercusTestFramework child class.
            self.num_nodes = 1
