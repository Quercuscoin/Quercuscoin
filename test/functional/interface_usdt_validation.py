...
""" Tests the validation:* tracepoint API interface.
    See https://github.com/quercus/quercus/blob/master/doc/tracing.md#context-validation
"""
...
class ValidationTracepointTest(QuercusTestFramework):
    ...
    def run_test(self):
        ...
        # blocks.
        # See https://github.com/quercus/quercus/blob/master/doc/tracing.md#tracepoint-validationblock_connected
