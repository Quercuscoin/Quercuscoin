...
#ifndef QUERCUS_COMPAT_ASSUMPTIONS_H
#define QUERCUS_COMPAT_ASSUMPTIONS_H
...
#if defined(NDEBUG)
# error "Quercus cannot be compiled without assertions."
#endif
...
#endif // QUERCUS_COMPAT_ASSUMPTIONS_H
