...
#ifndef QUERCUS_TEST_SCRIPTNUM10_H
#define QUERCUS_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Quercus Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // QUERCUS_TEST_SCRIPTNUM10_H
