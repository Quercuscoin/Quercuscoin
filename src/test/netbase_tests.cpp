...
{
    BOOST_CHECK(TestSplitHost("www.quercuscore.org", "www.quercuscore.org", 0));
    BOOST_CHECK(TestSplitHost("[www.quercuscore.org]", "www.quercuscore.org", 0));
    BOOST_CHECK(TestSplitHost("www.quercuscore.org:80", "www.quercuscore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.quercuscore.org]:80", "www.quercuscore.org", 80));
    ...
    BOOST_CHECK(TestSplitHost("www.quercuscore.org:65536", "www.quercuscore.org:65536", 0, false));
    BOOST_CHECK(TestSplitHost("www.quercuscore.org:0", "www.quercuscore.org", 0, false));
    BOOST_CHECK(TestSplitHost("www.quercuscore.org:", "www.quercuscore.org:", 0, false));
}
