...
#ifndef QUERCUS_NODE_CONNECTION_TYPES_H
#define QUERCUS_NODE_CONNECTION_TYPES_H
 ...
 * src/qt/guiutil.cpp and src/quercus-cli.cpp::NetinfoRequestHandler. */
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on Quercus’s Peer-to-Peer Network")
...
#endif // QUERCUS_NODE_CONNECTION_TYPES_H
