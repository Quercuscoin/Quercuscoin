...
#ifndef QUERCUS_CRYPTO_CHACHA_POLY_AEAD_H
#define QUERCUS_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@quercus.
 *
 ...
 *
 * The chacha20-poly1305@quercus combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@quercus cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@quercus are relatively fast in
...
#endif // QUERCUS_CRYPTO_CHACHA_POLY_AEAD_H
