...
#ifndef QUERCUS_PROTOCOL_H
#define QUERCUS_PROTOCOL_H
...
/**
 * Quercus protocol message types. When adding new message types, don't forget
...
enum ServiceFlags : uint64_t {
    ...
    // set by all Quercus Core non pruned nodes, and is unset by SPV clients or other light clients.
    NODE_NETWORK = (1 << 0),
    // NODE_BLOOM means the node is capable and willing to handle bloom-filtered connections.
    // Quercus Core nodes used to support this by default, without advertising this bit,
    ...
    // quercus-development mailing list. Remember that service bits are just
