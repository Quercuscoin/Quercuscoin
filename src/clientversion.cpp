 ...
 * for both quercusd and quercus-qt, to make it harder for attackers to
 * target servers or GUI users specifically.
 */
const std::string CLIENT_NAME("Quercus");
...
/**
 * Format the subversion field according to BIP 14 spec (https://github.com/quercus/bips/blob/master/bip-0014.mediawiki)
 */
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/quercus/quercus>";
