...
#ifndef QUERCUS_SCRIPT_STANDARD_H
#define QUERCUS_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a quercus address
 */
...
/**
 * Generate a Quercus scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // QUERCUS_SCRIPT_STANDARD_H
