...
#ifndef QUERCUS_INTERFACES_NODE_H
#define QUERCUS_INTERFACES_NODE_H
...
//! Top-level interface for a quercus node (quercusd process).
class Node
{
public:
    virtual ~Node() {}
    ...
    //! Return setting value from <datadir>/settings.json or quercus.conf.
...
#endif // QUERCUS_INTERFACES_NODE_H
