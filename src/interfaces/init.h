...
#ifndef QUERCUS_INTERFACES_INIT_H
#define QUERCUS_INTERFACES_INIT_H
...
//! (quercus-gui, quercus-node, quercus-wallet, quercusd, quercus-qt) and each
...
#endif // QUERCUS_INTERFACES_INIT_H
