...
#ifndef QUERCUS_QT_GUIUTIL_H
#define QUERCUS_QT_GUIUTIL_H
...
/** Utility functions used by the Quercus Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "quercus:" URI into recipient object, return true on successful parsing
