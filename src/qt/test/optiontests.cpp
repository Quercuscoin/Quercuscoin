...
{
    // Test regression https://github.com/quercus/quercus/issues/24457. Ensure
...
{
    // Test that the bug https://github.com/quercus-core/gui/issues/567 does not resurface.
    // It was fixed via https://github.com/quercus-core/gui/pull/568.
    // With fListen=false in ~/.config/Quercus/Quercus-Qt.conf and all else left as default,
    // quercus-qt should set both -listen and -listenonion to false and start successfully.
