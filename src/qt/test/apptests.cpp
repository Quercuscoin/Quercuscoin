...
//! Entry point for QuercusApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &QuercusApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for QuercusGUI tests.
void AppTests::guiTests(QuercusGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &QuercusGUI::consoleShown, this, &AppTests::consoleTests);
