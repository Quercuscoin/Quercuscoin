      ...
      ui(new Ui::OptionsDialog)
{
    ...
    ui->quercusAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->quercusAtStartup);
    ...
    ui->quercusAtStartup->setToolTip(ui->quercusAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->quercusAtStartup->setText(ui->quercusAtStartup->text().arg(PACKAGE_NAME));

    ui->openQuercusConfButton->setToolTip(ui->openQuercusConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new QuercusUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->quercusAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openQuercusConfButton_clicked()
{
