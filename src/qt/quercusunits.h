...
#ifndef QUERCUS_QT_QUERCUSUNITS_H
#define QUERCUS_QT_QUERCUSUNITS_H
...
/** Quercus unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class QuercusUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit QuercusUnits(QObject *parent);

    /** Quercus units.
      @note Source: https://en.quercus.it/wiki/Units . Please add only sensible ones
     */
    enum class Unit {
        FIX,
        mFIX,
