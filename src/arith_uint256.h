...
#ifndef QUERCUS_ARITH_UINT256_H
#define QUERCUS_ARITH_UINT256_H
...
public:
     ...
     *
     * Quercus only uses this "compact" format for encoding difficulty
