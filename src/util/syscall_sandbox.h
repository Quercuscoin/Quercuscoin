...
#ifndef QUERCUS_UTIL_SYSCALL_SANDBOX_H
#define QUERCUS_UTIL_SYSCALL_SANDBOX_H
...
//!
//! SetupSyscallSandbox(...) is called during quercusd initialization if Quercus Core was compiled
...
#endif // QUERCUS_UTIL_SYSCALL_SANDBOX_H
