 ...
 */
#ifndef QUERCUS_UTIL_SYSTEM_H
#define QUERCUS_UTIL_SYSTEM_H
...
extern const char * const QUERCUS_CONF_FILENAME;
extern const char * const QUERCUS_SETTINGS_FILENAME;
