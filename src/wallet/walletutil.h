...
#ifndef QUERCUS_WALLET_WALLETUTIL_H
#define QUERCUS_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! quercus from opening the wallet, thinking it was newly created, and
...
#endif // QUERCUS_WALLET_WALLETUTIL_H
