...
#ifndef QUERCUS_WALLET_TRANSACTION_H
#define QUERCUS_WALLET_TRANSACTION_H
...
public:
     ...
     * on this quercus node, and set to 0 for transactions that were created
...
#endif // QUERCUS_WALLET_TRANSACTION_H
