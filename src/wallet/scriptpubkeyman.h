...
#ifndef QUERCUS_WALLET_SCRIPTPUBKEYMAN_H
#define QUERCUS_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The Quercus Core wallet was originally a collection of unrelated private
...
#endif // QUERCUS_WALLET_SCRIPTPUBKEYMAN_H
