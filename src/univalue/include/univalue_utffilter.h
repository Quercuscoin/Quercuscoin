...
#ifndef QUERCUS_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
#define QUERCUS_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
...
#endif // QUERCUS_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
