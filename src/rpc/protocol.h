...
#ifndef QUERCUS_RPC_PROTOCOL_H
#define QUERCUS_RPC_PROTOCOL_H
...
enum RPCErrorCode
{
    ...
    // RPC_INTERNAL_ERROR should only be used for genuine errors in quercusd
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //!< Quercus is not connected
