...
"""Example logging Quercus Core utxo set cache flushes utilizing
    the utxocache:flush tracepoint."""

# USAGE:  ./contrib/tracing/log_utxocache_flush.py path/to/quercusd
...
def main(quercusd_path):
    ...
    b = BPF(text=program, usdt_contexts=[quercusd_with_usdts])
