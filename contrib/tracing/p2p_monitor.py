...
""" Interactive quercusd P2P network traffic monitor utilizing USDT and the
    net:inbound_message and net:outbound_message tracepoints. """

# This script demonstrates what USDT for Quercus Core can enable. It uses BCC
...
def main(quercusd_path):
    ...
    quercusd_with_usdts.enable_probe(
