...
complete --command quercus-qt --no-files

# Extract options
function __fish_quercusqt_get_options
...
complete \
    --command quercus-qt \
    --arguments "(__fish_quercusqt_get_options --nofiles)"
