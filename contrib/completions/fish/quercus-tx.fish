...
# Extract options
function __fish_quercus_tx_get_options
...
# Extract commands
function __fish_quercus_tx_get_commands
...
complete \
    --command quercus-tx \
    --condition "not __fish_quercus_seen_cmd (__fish_quercus_tx_get_commands --commandsonly)" \
    --arguments "(__fish_quercus_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command quercus-tx \
    --arguments "(__fish_quercus_tx_get_commands)" \
    --no-files
