...
complete --command quercusd --no-files

# Extract options
function __fish_quercusd_get_options
...
complete \
    --command quercusd \
    --arguments "(__fish_quercusd_get_options --nofiles)"
