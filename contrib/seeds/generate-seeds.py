...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef QUERCUS_CHAINPARAMSSEEDS_H\n')
    g.write('#define QUERCUS_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the quercus network\n')
    ...
    g.write('#endif // QUERCUS_CHAINPARAMSSEEDS_H\n')
