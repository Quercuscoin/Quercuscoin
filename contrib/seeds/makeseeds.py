...
def parse_args():
    argparser = argparse.ArgumentParser(description='Generate a list of quercus node seed ip addresses.')
...
def main():
    ...
    # Filter out hosts with multiple quercus ports, these are likely abusive
    ips = filtermultiport(ips)
    print(f'{ip_stats(ips):s} Filter out hosts with multiple quercus ports', file=sys.stderr)
